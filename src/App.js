        ...
        {myAddress !== DEFAULT_ADDRESS && tab === "DETAIL" ? (
          <div className="container" style={{ padding: 0, width: "100%" }}>
            ...
            <div className="nftDetailContent">
              ...
              <div><label className="detailLb">카테고리</label><span className="detailCont"><span className="detailCont">{ nft.uri.category == "dining" ? "식사권" : nft.uri.category == "class" ? "쿠킹 클래스" : "리미티드 예약" } </span></span></div>
